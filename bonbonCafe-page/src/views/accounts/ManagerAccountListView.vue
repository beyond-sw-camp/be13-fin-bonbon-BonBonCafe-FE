...
<!--   
  ...
  const goToManagerDetail = (userId) => {
    console.log("userId:", userId);
    router.push({ name: 'manager-accounts', params: { userId: userId } });
  };
  
  const goToCreateManager = () => {
    router.push({ name: 'manager-regist' });
  };
  ...
  const headers = [
    { title: '담당자 이름', align: 'center', key: 'name' },
    { title: '이메일', align: 'center', key: 'email' },
    { title: '전화번호', align: 'center', key: 'phone' },
    { title: '지역구', align: 'center', key: 'region' },
