  ...
  <form @submit.prevent="SubmitEvent">
    <v-container class="container">
      <div class="franchiseTable">
        ...
        <div class="cell" style="height: 70px;">
          <v-text-field v-model="franchiseTel" type="tel" density="comfortable" variant="outlined" class=" textBox" />
        </div>
...
const form = reactive({
  ...
  openTime: '',
  closeTime: '',
  parkingAvailability: '', // 가능/불가
  seatingCapacity: 0,
  franchiseImage: null,
  franchiseeImage: null,
  address: '', // KakaoAPI로 전달받은 주소
});
